...
class BvBench(TestBase):
    ...
    def test_p01_d1(self):
        ...
        consts = {self.const(0x00000000): 1, self.const(0xFFFFFFFF): 1, self.const(0x00000001): 1}
    ...
    def test_p02_d0(self):
        ...
        consts = {self.const(0x00000001): 1}
    ...
    def test_p03_d1(self):
        ...
        consts = {self.const(0x00000001): 1, self.const(0x00000000): 1, self.const(0xFFFFFFFF): 1}
    ...
    def test_p04_d1(self):
        ...
        consts = {self.const(0x00000000): 1, self.const(0x00000001): 1, self.const(0xFFFFFFFF): 1}
    ...
    def test_p09_d0(self):
        x = BitVec('x', self.width)
        spec = Func('p09', (x ^ (x >> 0x0000001F)) - (x >> 0x0000001F))
        ops = [self.bv.sub_, self.bv.ashr_, self.bv.xor_]
        consts = {self.const(0x0000001F): 1}
    ...
    def test_p09_d1(self):
        ...
        consts = {self.const(0x00000001): 1, self.const(0x00000000): 1, self.const(0x0000001F): 1, self.const(0xFFFFFFFF): 1}
    ...
    def test_p13_d0(self):
        x = BitVec('x', self.width)
        spec = Func('p13', (x >> 0x0000001F) | LShR(~x, 0x0000001F))
    ...
    def test_p13_d1(self):
        ...
        consts = {self.const(0x0000001F): 1, self.const(0x00000001): 1, self.const(0x00000000): 1, self.const(0xFFFFFFFF): 1}
    ...
    def test_p20_d1(self):
        ...
        consts = {self.const(0x00000002): 1, self.const(0x00000000): 1, self.const(0x00000001): 1}
...
if __name__ == '__main__':
    ...
    parser.add_argument('-b', '--width', type=int, default=32)
