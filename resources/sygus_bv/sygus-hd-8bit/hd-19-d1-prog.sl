...
(synth-fun f ((x (_ BitVec 8)) (m (_ BitVec 8)) (k (_ BitVec 8))) (_ BitVec 8)
    ((Start (_ BitVec 8)))
    ((Start (_ BitVec 8) ((bvand Start Start) (bvsub Start Start) (bvxor Start Start) (bvor Start Start) (bvand Start Start) (bvshl Start Start) (bvlshr Start Start) (bvashr Start Start) (bvnot Start) (bvneg Start) x m k))))
