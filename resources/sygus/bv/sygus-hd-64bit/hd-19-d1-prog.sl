...
(synth-fun f ((x (_ BitVec 64)) (m (_ BitVec 64)) (k (_ BitVec 64))) (_ BitVec 64)
    ((Start (_ BitVec 64)))
    ((Start (_ BitVec 64) ((bvand Start Start) (bvsub Start Start) (bvxor Start Start) (bvor Start Start) (bvand Start Start) (bvshl Start Start) (bvlshr Start Start) (bvashr Start Start) (bvnot Start) (bvneg Start) x m k))))
