...
def plot(file_name, set1_name, set2_name, set1_time, set2_time, freqs):
    plt.rcParams.update({ "figure.figsize": (6.5, 3.6), "font.family": "sans-serif", "font.sans-serif": ["Helvetica", "Arial", "DejaVu Sans"], "axes.labelsize": 12, "axes.titlesize": 12, "xtick.labelsize": 12, "ytick.labelsize": 12, "axes.linewidth": 0.8, "savefig.dpi": 600})
    ...
    ax.set_title(f"{set1_name} ({set1_time}s) Vs. {set2_name} ({set2_time}s)")
